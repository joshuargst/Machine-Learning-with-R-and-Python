...
It is likely that the segmentation into two groups defines individuals who do and do not have ADHD. With unsupervised learning, it is typically unknown what the clusters represent and a deeper dive into the information within each cluster is necessary to make that determination. This document will not dive into the specifics of each cluster arrangement.
